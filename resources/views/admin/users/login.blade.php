            ...
            <div class="col-12 pl-0 pr-0">
                ...
                <form action="{{ route('login') }}" method="post" enctype="multipart/form-data" autocomplete="off" class="form-inline">
                    ...
                    <div class="form-group col-12 mb-3">
                        ...
                        <input type="text" name="mobile" placeholder="Mobile Number" class="form-control col-sm-9 @error('mobile') is-invalid @enderror" id="fatherMobile" minlength="8" required value="{{ old('mobile') }}">
