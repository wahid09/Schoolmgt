...
<section class="container-fluid">
    <div class="row content register-form">
        <div class="col-12 pl-0 pr-0">
            ...
            <form method="POST" action="{{ route('slidersetup.update', $id=$slider->id) }}" enctype="multipart/form-data" autocomplete="off" class="form-inline">
                @csrf
                @method('PUT')

                <div class="form-group col-12 mb-3">
                    <label for="photo" class="col-sm-3 col-form-label text-right"></label>
                    <img src="{{ url('storage/slider/'.$slider->photo) }}" class="slide-photo" id="slider_photo">
                </div>
                <div class="form-group col-12 mb-3">
                ...
                <div class="form-group col-12 mb-3">
                    ...
                    <input id="title" type="text" class="col-sm-9 form-control @error('title') is-invalid @enderror" name="title" value="{{ $slider->title }}" placeholder="Slider Title">
                    @error('title')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                ...
                <div class="form-group col-12 mb-3">
                    ...
                    <textarea id="description" class="col-sm-9 form-control @error('description') is-invalid @enderror" name="description" placeholder="Write slider description in here....">{{ $slider->description }}</textarea>
                    @error('description')
                    <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                    </span>
